...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
        ...
        if (msg != null) {
            ...
            try {
                ...
                ((NewFriendsMsgActivity) context).executeRequest(new GsonRequest<User>(path,
                        User.class, responseFindUserListener(holder.name),
                ...
                try {
                    if (msg.getGroupId() == null) { //同意好友请求
                        ...
                        ((NewFriendsMsgActivity) context).executeRequest(new GsonRequest<Group>(path,
                                Group.class, responseAddGroupListener(button,msg),
                                ((NewFriendsMsgActivity) context).errorListener()));
    ...
    private Response.Listener<Group> responseAddGroupListener(final Button button,final InviteMessage msg) {
