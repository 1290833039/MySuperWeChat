...
public class GroupsActivity extends BaseActivity {
    ...
    public void onResume() {
        ...
        //	grouplist = EMGroupManager.getInstance().getAllGroups();
        grouplist = SuperWeChatApplication.getInstance().getGroupList();
        Log.i("main","GroupsActivity---------->onResume------->groupList="+grouplist);
        groupAdapter = new GroupAdapter(this, 1, grouplist);
        groupListView.setAdapter(groupAdapter);
    ...
    public void refresh() {
        if (groupListView != null && groupAdapter != null) {
            //	grouplist = EMGroupManager.getInstance().getAllGroups();
            grouplist = SuperWeChatApplication.getInstance().getGroupList();
            Log.i("main","GroupsActivity---------->refresh------->groupList="+grouplist);
    ...
    class GroupListChangedReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.i("main","GroupsActivity------>GroupListChangedReceiver---->groupAdapter.getCount()="+groupAdapter.getCount());
            if (groupAdapter.getCount() >= 3) {
                ...
                if (!grouplist.containsAll(list)) {
                    Log.i("main","GroupsActivity------>GroupListChangedReceiver---->list="+list);
